...
| [`zrm`](schemas/shuangpin/zrm/zrm.schema.yaml)<br>自然码·仓颉 | `pinyin_simp` | 默认启用。自然码双拼作主码，仓颉五代首尾码作辅助码；单字显式生成一至四码，词语生成短码、全双拼码及其辅码定重码；输入 `o` 加完整仓颉五代码可作仓颉兜底，必要时补 `z` 可直达仓颉候选。 |
