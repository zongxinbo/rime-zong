...
def main() -> None:
    parser = argparse.ArgumentParser(description="生成带固定词库的五码仓颉码表")
    parser.add_argument("--source-dict", type=Path, default=WUCANG5_DICT_PATH, help="已生成的 Wucang5 单字码表")
    parser.add_argument(
        "--words-dict",
        type=Path,
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=WUCANG5_DICT_PATH.with_name("wucang5_words.dict.yaml"),
        help="输出码表",
    )
