...
`最终简码条目` 使用 builder 口径，包含 `z_code` 字根码、一简、二简、三简：`31 + 25 + 200 + 400 = 656`。

当前 `summary.py` 摘要：

| 语料 | 频率降序-全码 | 频率降序-简码 | 原始码表-全码 | 原始码表-简码 | 简全联用-实际 |
| :--- | ---: | ---: | ---: | ---: | ---: |
| 知乎简体 | 23.11‱ | 447.67‱ | 3544.62‱ | 458.02‱ | 11.79‱ |
| 北语简体 | 14.88‱ | 508.83‱ | 3452.30‱ | 519.69‱ | 15.88‱ |
| 台标繁体 | 11.61‱ | 352.68‱ | 2051.48‱ | 635.03‱ | 26.47‱ |
| 古籍繁体 | 13.76‱ | 398.22‱ | 1575.09‱ | 1027.04‱ | 38.18‱ |
| 繁简联合 | 34.22‱ | 452.27‱ | 2586.44‱ | 504.03‱ | 24.10‱ |
