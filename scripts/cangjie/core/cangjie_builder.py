...
def generate_dict(
    ...
    vocabulary: str = None,
    max_phrase_length: int = 7,
    min_phrase_weight: int = 100
):
    ...
    with open(output_path, "w", encoding="utf-8") as f:
        ...
        if vocabulary:
            header += f"vocabulary: {vocabulary}\n"
            header += f"max_phrase_length: {max_phrase_length}\n"
            header += f"min_phrase_weight: {min_phrase_weight}\n"
        header += "...\n\n"
        f.write(header)
