...
def analyze_heatmap(dict_path, freq_path, charset_filter=is_gb2312, _preloaded_freq=None, max_length=4, simulate_punctuation=False, _preloaded_entries=None, commit_suffixes=None):
